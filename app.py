...
<div class="main-header">
    TRỢ LÍ CỦA CÔ LIỄU
    <p>Tác giả: Nguyễn Thị Liễu - Trường tiểu học Minh Dân - ĐT: 0359169611</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Liễu - Trường tiểu học Minh Dân - ĐT: 0359169611</div>", unsafe_allow_html=True)
